...
def modulo(a, b):
    ...
    # BUG: Incorrectly handles negative dividends
    # Should return positive remainder, but returns negative for negative a
    if a < 0:
        return -(abs(a) % abs(b))  # BUG: Returns negative instead of positive
    return a % b
